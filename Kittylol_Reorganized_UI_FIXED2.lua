...
do
    ...
    function __Library.CreateWindow(Self, config)
        ...
        function window:AddTab(tabConfig)
            ...
            page.Title = tabConfig.Title or tabConfig.Name or "Tab"
            return page
        end
    ...
    function __Library.AddSection(Self, name, side)
        local sideIndex = (side == "Right" or side == 2) and 2 or 1
        return Self:Section({
...
-- Load the supplied new UI library.
local __NewLibrary = getgenv().Library
if not __NewLibrary then
    error("Kittylol Library failed to initialize")
end
