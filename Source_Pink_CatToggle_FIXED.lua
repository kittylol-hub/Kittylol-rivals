...
local Library do
    ...
    local function CreateCatToggle()
        ...
        Cat.InputBegan:Connect(function(input)
            if input.UserInputType == Enum.UserInputType.MouseButton1
                or input.UserInputType == Enum.UserInputType.Touch then
                dragging = true
                moved = false
                dragStart = input.Position
                startPos = Cat.Position
        ...
        UserInputService.InputChanged:Connect(function(input)
            ...
            Cat.Position = UDim2.new(
                startPos.X.Scale, startPos.X.Offset + delta.X,
                startPos.Y.Scale, startPos.Y.Offset + delta.Y
            )
        end)

        Cat.Activated:Connect(function()
            if moved then return end

            local holder = Library and Library.Holder
            if holder and holder.Instance then
                holder.Instance.Enabled = not holder.Instance.Enabled
            end
        end)
        ...
        Library.CreateKeybind = function(self, Data)
            ...
            local Items = { } do
                Items["KeyButton"] = Instances:Create("TextButton", {
                    ...
                    Name = "\0",
                    FontFace = Library.Font,
                    TextColor3 = FromRGB(255, 170, 210),
                    BorderColor3 = FromRGB(0, 0, 0),
                    Text = "-",
                    AutoButtonColor = false,
                    Size = UDim2New(0, 0, 1, 0),
            ...
            function Keybind:SetMode(Mode)
                for Index, Value in Modes do 
                    if Index == Mode then
                        Value:Tween(nil, {TextColor3 = FromRGB(255, 170, 210)})
                    else
                        Value:Tween(nil, {TextColor3 = FromRGB(255, 170, 210)})
                    end
                end
...
if Window.Logo and Window.Logo ~= "" then
    ...
    if Page.Active then
        ...
        Items["Text"]:Tween(nil, {TextColor3 = FromRGB(255, 170, 210)})
...
local NewColumn = Instances:Create("ScrollingFrame", {
    ...
    if Page.Active then
        ...
        Items["Inactive"]:Tween(nil, {TextColor3 = FromRGB(255, 170, 210)})
    end
end
...
Library.Sections.Button = function(self, Data)
    ...
    function Button:Press()
        ...
        Items["Button"]:Tween(nil, {
            ...
            TextColor3 = FromRGB(255, 170, 210)  -- White text on element background
        })
    ...
    Items["Button"]:Connect("MouseLeave", function()
        Items["Button"]:Tween(nil, {TextColor3 = FromRGB(255, 170, 210)})
    end)
            ...
            function Dropdown:Add(Option)
                ...
                function OptionData:Toggle(Value)
                    if Value == "Active" then
                        ...
                        OptionData.Button:Tween(nil, {BackgroundTransparency = 1, TextColor3 = FromRGB(255, 170, 210)})
                    end
                end
